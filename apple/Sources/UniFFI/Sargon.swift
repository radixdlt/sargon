...
public struct FfiConverterTypeAccount: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Account {
        return
            try Account(
                ...
                flags: FfiConverterTypeEntityFlags.read(from: &buf),
    ...
    public static func write(_ value: Account, into buf: inout [UInt8]) {
        ...
        FfiConverterTypeEntityFlags.write(value.flags, into: &buf)
...
public struct Accounts {
    fileprivate let secretMagic: AccountsSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: AccountsSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension Accounts: Sendable {}
extension Accounts: Equatable, Hashable {
...
public struct FfiConverterTypeAccounts: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Accounts {
        return
            try Accounts(
                secretMagic: FfiConverterTypeAccountsSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: Accounts, into buf: inout [UInt8]) {
        FfiConverterTypeAccountsSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypeAccounts_lift(_ buf: RustBuffer) throws -> Accounts {
    return try FfiConverterTypeAccounts.lift(buf)
}

public func FfiConverterTypeAccounts_lower(_ value: Accounts) -> RustBuffer {
    return FfiConverterTypeAccounts.lower(value)
}
...
public struct FfiConverterTypeAppPreferences: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AppPreferences {
        return
            try AppPreferences(
                ...
                p2pLinks: FfiConverterTypeP2PLinks.read(from: &buf),
    ...
    public static func write(_ value: AppPreferences, into buf: inout [UInt8]) {
        ...
        FfiConverterTypeP2PLinks.write(value.p2pLinks, into: &buf)
 ...
 */
public struct AuthorizedDapps {
    fileprivate let secretMagic: AuthorizedDappsSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: AuthorizedDappsSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension AuthorizedDapps: Sendable {}
extension AuthorizedDapps: Equatable, Hashable {
    public static func == (lhs: AuthorizedDapps, rhs: AuthorizedDapps) -> Bool {
        if lhs.secretMagic != rhs.secretMagic {
            return false
        }
        return true
...
public struct FfiConverterTypeAuthorizedDapps: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AuthorizedDapps {
        return
            try AuthorizedDapps(
                secretMagic: FfiConverterTypeAuthorizedDappsSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: AuthorizedDapps, into buf: inout [UInt8]) {
        FfiConverterTypeAuthorizedDappsSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypeAuthorizedDapps_lift(_ buf: RustBuffer) throws -> AuthorizedDapps {
    return try FfiConverterTypeAuthorizedDapps.lift(buf)
}

public func FfiConverterTypeAuthorizedDapps_lower(_ value: AuthorizedDapps) -> RustBuffer {
    return FfiConverterTypeAuthorizedDapps.lower(value)
}
...
public struct EntityFlags {
    fileprivate let secretMagic: EntityFlagsSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: EntityFlagsSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension EntityFlags: Sendable {}
extension EntityFlags: Equatable, Hashable {
    public static func == (lhs: EntityFlags, rhs: EntityFlags) -> Bool {
        if lhs.secretMagic != rhs.secretMagic {
            return false
        }
        return true
...
public struct FfiConverterTypeEntityFlags: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> EntityFlags {
        return
            try EntityFlags(
                secretMagic: FfiConverterTypeEntityFlagsSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: EntityFlags, into buf: inout [UInt8]) {
        FfiConverterTypeEntityFlagsSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypeEntityFlags_lift(_ buf: RustBuffer) throws -> EntityFlags {
    return try FfiConverterTypeEntityFlags.lift(buf)
}

public func FfiConverterTypeEntityFlags_lower(_ value: EntityFlags) -> RustBuffer {
    return FfiConverterTypeEntityFlags.lower(value)
}
...
public struct FactorSourceCryptoParameters {
     ...
     * Must not be empty.
     */
    public var supportedCurves: SupportedCurves
    /**
...
public struct FfiConverterTypeFactorSourceCryptoParameters: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FactorSourceCryptoParameters {
        return
            try FactorSourceCryptoParameters(
                supportedCurves: FfiConverterTypeSupportedCurves.read(from: &buf),
    ...
    public static func write(_ value: FactorSourceCryptoParameters, into buf: inout [UInt8]) {
        FfiConverterTypeSupportedCurves.write(value.supportedCurves, into: &buf)
...
public struct FactorSources {
    fileprivate let secretMagic: FactorSourcesSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: FactorSourcesSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension FactorSources: Sendable {}
extension FactorSources: Equatable, Hashable {
    public static func == (lhs: FactorSources, rhs: FactorSources) -> Bool {
        if lhs.secretMagic != rhs.secretMagic {
            return false
        }
        return true
...
public struct FfiConverterTypeFactorSources: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FactorSources {
        return
            try FactorSources(
                secretMagic: FfiConverterTypeFactorSourcesSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: FactorSources, into buf: inout [UInt8]) {
        FfiConverterTypeFactorSourcesSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypeFactorSources_lift(_ buf: RustBuffer) throws -> FactorSources {
    return try FfiConverterTypeFactorSources.lift(buf)
}

public func FfiConverterTypeFactorSources_lower(_ value: FactorSources) -> RustBuffer {
    return FfiConverterTypeFactorSources.lower(value)
}
...
public struct Gateways {
     ...
     */
    public var other: OtherGateways
 ...
 * other networks, the identifier of a Gateway is the URL.
 */
public struct OtherGateways {
    fileprivate let secretMagic: OtherGatewaysSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: OtherGatewaysSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension OtherGateways: Sendable {}
extension OtherGateways: Equatable, Hashable {
    public static func == (lhs: OtherGateways, rhs: OtherGateways) -> Bool {
        if lhs.secretMagic != rhs.secretMagic {
            return false
        }
        return true
...
public struct FfiConverterTypeOtherGateways: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> OtherGateways {
        return
            try OtherGateways(
                secretMagic: FfiConverterTypeOtherGatewaysSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: OtherGateways, into buf: inout [UInt8]) {
        FfiConverterTypeOtherGatewaysSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypeOtherGateways_lift(_ buf: RustBuffer) throws -> OtherGateways {
    return try FfiConverterTypeOtherGateways.lift(buf)
}

public func FfiConverterTypeOtherGateways_lower(_ value: OtherGateways) -> RustBuffer {
    return FfiConverterTypeOtherGateways.lower(value)
}
...
public struct P2pLinks {
    fileprivate let secretMagic: P2PLinksSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: P2PLinksSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension P2pLinks: Sendable {}
extension P2pLinks: Equatable, Hashable {
    public static func == (lhs: P2pLinks, rhs: P2pLinks) -> Bool {
        if lhs.secretMagic != rhs.secretMagic {
            return false
        }
        return true
...
public struct FfiConverterTypeP2PLinks: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> P2pLinks {
        return
            try P2pLinks(
                secretMagic: FfiConverterTypeP2PLinksSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: P2pLinks, into buf: inout [UInt8]) {
        FfiConverterTypeP2PLinksSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypeP2PLinks_lift(_ buf: RustBuffer) throws -> P2pLinks {
    return try FfiConverterTypeP2PLinks.lift(buf)
}

public func FfiConverterTypeP2PLinks_lower(_ value: P2pLinks) -> RustBuffer {
    return FfiConverterTypeP2PLinks.lower(value)
}
...
public struct Personas {
    fileprivate let secretMagic: PersonasSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: PersonasSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension Personas: Sendable {}
extension Personas: Equatable, Hashable {
    public static func == (lhs: Personas, rhs: Personas) -> Bool {
        if lhs.secretMagic != rhs.secretMagic {
            return false
        }
        return true
...
public struct FfiConverterTypePersonas: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Personas {
        return
            try Personas(
                secretMagic: FfiConverterTypePersonasSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: Personas, into buf: inout [UInt8]) {
        FfiConverterTypePersonasSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypePersonas_lift(_ buf: RustBuffer) throws -> Personas {
    return try FfiConverterTypePersonas.lift(buf)
}

public func FfiConverterTypePersonas_lower(_ value: Personas) -> RustBuffer {
    return FfiConverterTypePersonas.lower(value)
}
...
public struct Profile {
     ...
     */
    public var networks: ProfileNetworks
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Profile {
        return
            try Profile(
                ...
                factorSources: FfiConverterTypeFactorSources.read(from: &buf),
                appPreferences: FfiConverterTypeAppPreferences.read(from: &buf),
                networks: FfiConverterTypeProfileNetworks.read(from: &buf)
            )
    }

    public static func write(_ value: Profile, into buf: inout [UInt8]) {
        FfiConverterTypeHeader.write(value.header, into: &buf)
        FfiConverterTypeFactorSources.write(value.factorSources, into: &buf)
        FfiConverterTypeAppPreferences.write(value.appPreferences, into: &buf)
        FfiConverterTypeProfileNetworks.write(value.networks, into: &buf)
    }
}
...
public struct FfiConverterTypeProfileNetwork: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ProfileNetwork {
        return
            try ProfileNetwork(
                id: FfiConverterTypeNetworkID.read(from: &buf),
                accounts: FfiConverterTypeAccounts.read(from: &buf),
                personas: FfiConverterTypePersonas.read(from: &buf),
                authorizedDapps: FfiConverterTypeAuthorizedDapps.read(from: &buf)
            )
    }

    public static func write(_ value: ProfileNetwork, into buf: inout [UInt8]) {
        FfiConverterTypeNetworkID.write(value.id, into: &buf)
        FfiConverterTypeAccounts.write(value.accounts, into: &buf)
        FfiConverterTypePersonas.write(value.personas, into: &buf)
        FfiConverterTypeAuthorizedDapps.write(value.authorizedDapps, into: &buf)
    }
}
 ...
 * has created and interacted with on this network.
 */
public struct ProfileNetworks {
    fileprivate let secretMagic: ProfileNetworksSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: ProfileNetworksSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension ProfileNetworks: Sendable {}
extension ProfileNetworks: Equatable, Hashable {
    public static func == (lhs: ProfileNetworks, rhs: ProfileNetworks) -> Bool {
        if lhs.secretMagic != rhs.secretMagic {
            return false
        }
        return true
...
public struct FfiConverterTypeProfileNetworks: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ProfileNetworks {
        return
            try ProfileNetworks(
                secretMagic: FfiConverterTypeProfileNetworksSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: ProfileNetworks, into buf: inout [UInt8]) {
        FfiConverterTypeProfileNetworksSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypeProfileNetworks_lift(_ buf: RustBuffer) throws -> ProfileNetworks {
    return try FfiConverterTypeProfileNetworks.lift(buf)
}

public func FfiConverterTypeProfileNetworks_lower(_ value: ProfileNetworks) -> RustBuffer {
    return FfiConverterTypeProfileNetworks.lower(value)
}
 ...
 * MUST never be empty.
 */
public struct SupportedCurves {
    fileprivate let secretMagic: SupportedCurvesSecretMagic

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    fileprivate init(secretMagic: SupportedCurvesSecretMagic) {
        self.secretMagic = secretMagic
    }
}

extension SupportedCurves: Sendable {}
extension SupportedCurves: Equatable, Hashable {
    public static func == (lhs: SupportedCurves, rhs: SupportedCurves) -> Bool {
        if lhs.secretMagic != rhs.secretMagic {
            return false
        }
        return true
...
public struct FfiConverterTypeSupportedCurves: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SupportedCurves {
        return
            try SupportedCurves(
                secretMagic: FfiConverterTypeSupportedCurvesSecretMagic.read(from: &buf)
            )
    }

    public static func write(_ value: SupportedCurves, into buf: inout [UInt8]) {
        FfiConverterTypeSupportedCurvesSecretMagic.write(value.secretMagic, into: &buf)
    }
}

public func FfiConverterTypeSupportedCurves_lift(_ buf: RustBuffer) throws -> SupportedCurves {
    return try FfiConverterTypeSupportedCurves.lift(buf)
}

public func FfiConverterTypeSupportedCurves_lower(_ value: SupportedCurves) -> RustBuffer {
    return FfiConverterTypeSupportedCurves.lower(value)
}
...
public struct TransactionGuarantee {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(amount: Decimal192, instructionIndex: UInt64, resourceAddress: ResourceAddress, resourceDivisibility: UInt8?) {
        self.amount = amount
        self.instructionIndex = instructionIndex
        self.resourceAddress = resourceAddress
...
private struct FfiConverterOptionTypeAccount: FfiConverterRustBuffer {
...
private struct FfiConverterOptionTypeAuthorizedDapp: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeAuthorizedDapp.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeAuthorizedDapp.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
private struct FfiConverterOptionTypeGateway: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeGateway.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeGateway.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
private struct FfiConverterOptionTypeP2PLink: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeP2PLink.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeP2PLink.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}

private struct FfiConverterOptionTypePersona: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypePersona.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypePersona.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
private struct FfiConverterOptionTypeProfileNetwork: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeProfileNetwork.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeProfileNetwork.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
private struct FfiConverterOptionTypeEntityFlag: FfiConverterRustBuffer {
    typealias SwiftType = EntityFlag?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeEntityFlag.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeEntityFlag.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}

private struct FfiConverterOptionTypeFactorSource: FfiConverterRustBuffer {
    typealias SwiftType = FactorSource?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeFactorSource.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeFactorSource.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}

private struct FfiConverterOptionTypeSLIP10Curve: FfiConverterRustBuffer {
    typealias SwiftType = Slip10Curve?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeSLIP10Curve.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeSLIP10Curve.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
 ...
 */
public typealias AccountsSecretMagic = [Account]
public struct FfiConverterTypeAccountsSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AccountsSecretMagic {
        return try FfiConverterSequenceTypeAccount.read(from: &buf)
    }

    public static func write(_ value: AccountsSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypeAccount.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> AccountsSecretMagic {
        return try FfiConverterSequenceTypeAccount.lift(value)
    }

    public static func lower(_ value: AccountsSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypeAccount.lower(value)
    }
}

public func FfiConverterTypeAccountsSecretMagic_lift(_ value: RustBuffer) throws -> AccountsSecretMagic {
    return try FfiConverterTypeAccountsSecretMagic.lift(value)
}

public func FfiConverterTypeAccountsSecretMagic_lower(_ value: AccountsSecretMagic) -> RustBuffer {
    return FfiConverterTypeAccountsSecretMagic.lower(value)
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias AuthorizedDappsSecretMagic = [AuthorizedDapp]
public struct FfiConverterTypeAuthorizedDappsSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AuthorizedDappsSecretMagic {
        return try FfiConverterSequenceTypeAuthorizedDapp.read(from: &buf)
    }

    public static func write(_ value: AuthorizedDappsSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypeAuthorizedDapp.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> AuthorizedDappsSecretMagic {
        return try FfiConverterSequenceTypeAuthorizedDapp.lift(value)
    }

    public static func lower(_ value: AuthorizedDappsSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypeAuthorizedDapp.lower(value)
    }
}

public func FfiConverterTypeAuthorizedDappsSecretMagic_lift(_ value: RustBuffer) throws -> AuthorizedDappsSecretMagic {
    return try FfiConverterTypeAuthorizedDappsSecretMagic.lift(value)
}

public func FfiConverterTypeAuthorizedDappsSecretMagic_lower(_ value: AuthorizedDappsSecretMagic) -> RustBuffer {
    return FfiConverterTypeAuthorizedDappsSecretMagic.lower(value)
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias EntityFlagsSecretMagic = [EntityFlag]
public struct FfiConverterTypeEntityFlagsSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> EntityFlagsSecretMagic {
        return try FfiConverterSequenceTypeEntityFlag.read(from: &buf)
    }

    public static func write(_ value: EntityFlagsSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypeEntityFlag.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> EntityFlagsSecretMagic {
        return try FfiConverterSequenceTypeEntityFlag.lift(value)
    }

    public static func lower(_ value: EntityFlagsSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypeEntityFlag.lower(value)
    }
}

public func FfiConverterTypeEntityFlagsSecretMagic_lift(_ value: RustBuffer) throws -> EntityFlagsSecretMagic {
    return try FfiConverterTypeEntityFlagsSecretMagic.lift(value)
}

public func FfiConverterTypeEntityFlagsSecretMagic_lower(_ value: EntityFlagsSecretMagic) -> RustBuffer {
    return FfiConverterTypeEntityFlagsSecretMagic.lower(value)
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias FactorSourcesSecretMagic = [FactorSource]
public struct FfiConverterTypeFactorSourcesSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FactorSourcesSecretMagic {
        return try FfiConverterSequenceTypeFactorSource.read(from: &buf)
    }

    public static func write(_ value: FactorSourcesSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypeFactorSource.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> FactorSourcesSecretMagic {
        return try FfiConverterSequenceTypeFactorSource.lift(value)
    }

    public static func lower(_ value: FactorSourcesSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypeFactorSource.lower(value)
    }
}

public func FfiConverterTypeFactorSourcesSecretMagic_lift(_ value: RustBuffer) throws -> FactorSourcesSecretMagic {
    return try FfiConverterTypeFactorSourcesSecretMagic.lift(value)
}

public func FfiConverterTypeFactorSourcesSecretMagic_lower(_ value: FactorSourcesSecretMagic) -> RustBuffer {
    return FfiConverterTypeFactorSourcesSecretMagic.lower(value)
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias OtherGatewaysSecretMagic = [Gateway]
public struct FfiConverterTypeOtherGatewaysSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> OtherGatewaysSecretMagic {
        return try FfiConverterSequenceTypeGateway.read(from: &buf)
    }

    public static func write(_ value: OtherGatewaysSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypeGateway.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> OtherGatewaysSecretMagic {
        return try FfiConverterSequenceTypeGateway.lift(value)
    }

    public static func lower(_ value: OtherGatewaysSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypeGateway.lower(value)
    }
}

public func FfiConverterTypeOtherGatewaysSecretMagic_lift(_ value: RustBuffer) throws -> OtherGatewaysSecretMagic {
    return try FfiConverterTypeOtherGatewaysSecretMagic.lift(value)
}

public func FfiConverterTypeOtherGatewaysSecretMagic_lower(_ value: OtherGatewaysSecretMagic) -> RustBuffer {
    return FfiConverterTypeOtherGatewaysSecretMagic.lower(value)
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias P2PLinksSecretMagic = [P2pLink]
public struct FfiConverterTypeP2PLinksSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> P2PLinksSecretMagic {
        return try FfiConverterSequenceTypeP2PLink.read(from: &buf)
    }

    public static func write(_ value: P2PLinksSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypeP2PLink.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> P2PLinksSecretMagic {
        return try FfiConverterSequenceTypeP2PLink.lift(value)
    }

    public static func lower(_ value: P2PLinksSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypeP2PLink.lower(value)
    }
}

public func FfiConverterTypeP2PLinksSecretMagic_lift(_ value: RustBuffer) throws -> P2PLinksSecretMagic {
    return try FfiConverterTypeP2PLinksSecretMagic.lift(value)
}

public func FfiConverterTypeP2PLinksSecretMagic_lower(_ value: P2PLinksSecretMagic) -> RustBuffer {
    return FfiConverterTypeP2PLinksSecretMagic.lower(value)
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias PersonasSecretMagic = [Persona]
public struct FfiConverterTypePersonasSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PersonasSecretMagic {
        return try FfiConverterSequenceTypePersona.read(from: &buf)
    }

    public static func write(_ value: PersonasSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypePersona.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> PersonasSecretMagic {
        return try FfiConverterSequenceTypePersona.lift(value)
    }

    public static func lower(_ value: PersonasSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypePersona.lower(value)
    }
}

public func FfiConverterTypePersonasSecretMagic_lift(_ value: RustBuffer) throws -> PersonasSecretMagic {
    return try FfiConverterTypePersonasSecretMagic.lift(value)
}

public func FfiConverterTypePersonasSecretMagic_lower(_ value: PersonasSecretMagic) -> RustBuffer {
    return FfiConverterTypePersonasSecretMagic.lower(value)
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias ProfileNetworksSecretMagic = [ProfileNetwork]
public struct FfiConverterTypeProfileNetworksSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ProfileNetworksSecretMagic {
        return try FfiConverterSequenceTypeProfileNetwork.read(from: &buf)
    }

    public static func write(_ value: ProfileNetworksSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypeProfileNetwork.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> ProfileNetworksSecretMagic {
        return try FfiConverterSequenceTypeProfileNetwork.lift(value)
    }

    public static func lower(_ value: ProfileNetworksSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypeProfileNetwork.lower(value)
    }
}

public func FfiConverterTypeProfileNetworksSecretMagic_lift(_ value: RustBuffer) throws -> ProfileNetworksSecretMagic {
    return try FfiConverterTypeProfileNetworksSecretMagic.lift(value)
}

public func FfiConverterTypeProfileNetworksSecretMagic_lower(_ value: ProfileNetworksSecretMagic) -> RustBuffer {
    return FfiConverterTypeProfileNetworksSecretMagic.lower(value)
}
 ...
 * is needed because the UDL type name is used in function/method signatures.
 */
public typealias SupportedCurvesSecretMagic = [Slip10Curve]
public struct FfiConverterTypeSupportedCurvesSecretMagic: FfiConverter {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SupportedCurvesSecretMagic {
        return try FfiConverterSequenceTypeSLIP10Curve.read(from: &buf)
    }

    public static func write(_ value: SupportedCurvesSecretMagic, into buf: inout [UInt8]) {
        return FfiConverterSequenceTypeSLIP10Curve.write(value, into: &buf)
    }

    public static func lift(_ value: RustBuffer) throws -> SupportedCurvesSecretMagic {
        return try FfiConverterSequenceTypeSLIP10Curve.lift(value)
    }

    public static func lower(_ value: SupportedCurvesSecretMagic) -> RustBuffer {
        return FfiConverterSequenceTypeSLIP10Curve.lower(value)
    }
}

public func FfiConverterTypeSupportedCurvesSecretMagic_lift(_ value: RustBuffer) throws -> SupportedCurvesSecretMagic {
    return try FfiConverterTypeSupportedCurvesSecretMagic.lift(value)
}

public func FfiConverterTypeSupportedCurvesSecretMagic_lower(_ value: SupportedCurvesSecretMagic) -> RustBuffer {
    return FfiConverterTypeSupportedCurvesSecretMagic.lower(value)
}
...
public func accountsElementCount(accounts: Accounts) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_accounts_element_count(
            FfiConverterTypeAccounts.lower(accounts), $0
        )
    })
}

public func accountsGetAccountById(accounts: Accounts, id: AccountAddress) -> Account? {
    return try! FfiConverterOptionTypeAccount.lift(try! rustCall {
        uniffi_sargon_fn_func_accounts_get_account_by_id(
            FfiConverterTypeAccounts.lower(accounts),
            FfiConverterTypeAccountAddress.lower(id), $0
        )
    })
}

public func accountsGetElements(accounts: Accounts) -> [Account] {
    return try! FfiConverterSequenceTypeAccount.lift(try! rustCall {
        uniffi_sargon_fn_func_accounts_get_elements(
            FfiConverterTypeAccounts.lower(accounts), $0
        )
    })
}
...
public func authorizedDappsElementCount(authorizedDapps: AuthorizedDapps) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_authorized_dapps_element_count(
            FfiConverterTypeAuthorizedDapps.lower(authorizedDapps), $0
        )
    })
}

public func authorizedDappsGetAuthorizedDappById(authorizedDapps: AuthorizedDapps, id: AccountAddress) -> AuthorizedDapp? {
    return try! FfiConverterOptionTypeAuthorizedDapp.lift(try! rustCall {
        uniffi_sargon_fn_func_authorized_dapps_get_authorized_dapp_by_id(
            FfiConverterTypeAuthorizedDapps.lower(authorizedDapps),
            FfiConverterTypeAccountAddress.lower(id), $0
        )
    })
}

public func authorizedDappsGetElements(authorizedDapps: AuthorizedDapps) -> [AuthorizedDapp] {
    return try! FfiConverterSequenceTypeAuthorizedDapp.lift(try! rustCall {
        uniffi_sargon_fn_func_authorized_dapps_get_elements(
            FfiConverterTypeAuthorizedDapps.lower(authorizedDapps), $0
        )
    })
}
...
public func depositRuleToJsonString(rule: DepositRule) -> String {
    return try! FfiConverterString.lift(try! rustCall {
        uniffi_sargon_fn_func_deposit_rule_to_json_string(
            FfiConverterTypeDepositRule.lower(rule), $0
        )
    })
}
...
public func entityFlagsElementCount(entityFlags: EntityFlags) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_entity_flags_element_count(
            FfiConverterTypeEntityFlags.lower(entityFlags), $0
        )
    })
}

public func entityFlagsGetElements(entityFlags: EntityFlags) -> [EntityFlag] {
    return try! FfiConverterSequenceTypeEntityFlag.lift(try! rustCall {
        uniffi_sargon_fn_func_entity_flags_get_elements(
            FfiConverterTypeEntityFlags.lower(entityFlags), $0
        )
    })
}

public func entityFlagsGetEntityFlagById(entityFlags: EntityFlags, id: EntityFlag) -> EntityFlag? {
    return try! FfiConverterOptionTypeEntityFlag.lift(try! rustCall {
        uniffi_sargon_fn_func_entity_flags_get_entity_flag_by_id(
            FfiConverterTypeEntityFlags.lower(entityFlags),
            FfiConverterTypeEntityFlag.lower(id), $0
        )
    })
}
...
public func factorSourcesElementCount(factorSources: FactorSources) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_factor_sources_element_count(
            FfiConverterTypeFactorSources.lower(factorSources), $0
        )
    })
}

public func factorSourcesGetElements(factorSources: FactorSources) -> [FactorSource] {
    return try! FfiConverterSequenceTypeFactorSource.lift(try! rustCall {
        uniffi_sargon_fn_func_factor_sources_get_elements(
            FfiConverterTypeFactorSources.lower(factorSources), $0
        )
    })
}

public func factorSourcesGetFactorSourceById(factorSources: FactorSources, id: FactorSourceId) -> FactorSource? {
    return try! FfiConverterOptionTypeFactorSource.lift(try! rustCall {
        uniffi_sargon_fn_func_factor_sources_get_factor_source_by_id(
            FfiConverterTypeFactorSources.lower(factorSources),
            FfiConverterTypeFactorSourceID.lower(id), $0
        )
    })
}
 ...
 */
public func gatewaysGetAllElements(gateways: Gateways) -> [Gateway] {
    return try! FfiConverterSequenceTypeGateway.lift(try! rustCall {
        uniffi_sargon_fn_func_gateways_get_all_elements(
            FfiConverterTypeGateways.lower(gateways), $0
        )
    })
}

public func hash(data: BagOfBytes) -> Exactly32Bytes {
...
public func hashGetBytes(hash: Hash) -> BagOfBytes {
    return try! FfiConverterTypeBagOfBytes.lift(try! rustCall {
...
public func newAccounts(accounts: [Account]) -> Accounts {
    return try! FfiConverterTypeAccounts.lift(try! rustCall {
        uniffi_sargon_fn_func_new_accounts(
            FfiConverterSequenceTypeAccount.lower(accounts), $0
        )
    })
}

public func newAccountsByAppending(account: Account, to: Accounts) -> Accounts {
    return try! FfiConverterTypeAccounts.lift(try! rustCall {
        uniffi_sargon_fn_func_new_accounts_by_appending(
            FfiConverterTypeAccount.lower(account),
            FfiConverterTypeAccounts.lower(to), $0
        )
    })
}

public func newAccountsRemovedById(idOfAccount: AccountAddress, from: Accounts) -> Accounts {
    return try! FfiConverterTypeAccounts.lift(try! rustCall {
        uniffi_sargon_fn_func_new_accounts_removed_by_id(
            FfiConverterTypeAccountAddress.lower(idOfAccount),
            FfiConverterTypeAccounts.lower(from), $0
        )
    })
}

public func newAccountsRemovedElement(account: Account, from: Accounts) -> Accounts {
    return try! FfiConverterTypeAccounts.lift(try! rustCall {
        uniffi_sargon_fn_func_new_accounts_removed_element(
            FfiConverterTypeAccount.lower(account),
            FfiConverterTypeAccounts.lower(from), $0
        )
    })
...
public func newAccountsSample() -> Accounts {
    return try! FfiConverterTypeAccounts.lift(try! rustCall {
...
public func newAccountsSampleOther() -> Accounts {
    return try! FfiConverterTypeAccounts.lift(try! rustCall {
...
public func newAccountsWithAccount(account: Account) -> Accounts {
    return try! FfiConverterTypeAccounts.lift(try! rustCall {
        uniffi_sargon_fn_func_new_accounts_with_account(
            FfiConverterTypeAccount.lower(account), $0
        )
    })
}
...
public func newAuthorizedDapps(authorizedDapps: [AuthorizedDapp]) -> AuthorizedDapps {
    return try! FfiConverterTypeAuthorizedDapps.lift(try! rustCall {
        uniffi_sargon_fn_func_new_authorized_dapps(
            FfiConverterSequenceTypeAuthorizedDapp.lower(authorizedDapps), $0
        )
    })
}

public func newAuthorizedDappsByAppending(authorizedDapp: AuthorizedDapp, to: AuthorizedDapps) -> AuthorizedDapps {
    return try! FfiConverterTypeAuthorizedDapps.lift(try! rustCall {
        uniffi_sargon_fn_func_new_authorized_dapps_by_appending(
            FfiConverterTypeAuthorizedDapp.lower(authorizedDapp),
            FfiConverterTypeAuthorizedDapps.lower(to), $0
        )
    })
}

public func newAuthorizedDappsRemovedById(idOfAuthorizedDapp: AccountAddress, from: AuthorizedDapps) -> AuthorizedDapps {
    return try! FfiConverterTypeAuthorizedDapps.lift(try! rustCall {
        uniffi_sargon_fn_func_new_authorized_dapps_removed_by_id(
            FfiConverterTypeAccountAddress.lower(idOfAuthorizedDapp),
            FfiConverterTypeAuthorizedDapps.lower(from), $0
        )
    })
}

public func newAuthorizedDappsRemovedElement(authorizedDapp: AuthorizedDapp, from: AuthorizedDapps) -> AuthorizedDapps {
    return try! FfiConverterTypeAuthorizedDapps.lift(try! rustCall {
        uniffi_sargon_fn_func_new_authorized_dapps_removed_element(
            FfiConverterTypeAuthorizedDapp.lower(authorizedDapp),
            FfiConverterTypeAuthorizedDapps.lower(from), $0
        )
    })
...
public func newAuthorizedDappsSample() -> AuthorizedDapps {
    return try! FfiConverterTypeAuthorizedDapps.lift(try! rustCall {
...
public func newAuthorizedDappsSampleOther() -> AuthorizedDapps {
    return try! FfiConverterTypeAuthorizedDapps.lift(try! rustCall {
...
public func newAuthorizedDappsWithAuthorizedDapp(authorizedDapp: AuthorizedDapp) -> AuthorizedDapps {
    return try! FfiConverterTypeAuthorizedDapps.lift(try! rustCall {
        uniffi_sargon_fn_func_new_authorized_dapps_with_authorized_dapp(
 ...
 * ```
 */
public func newDecimalFromF32(value: Float) throws -> Decimal192 {
    return try FfiConverterTypeDecimal192.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
...
public func newEntityFlags(entityFlags: [EntityFlag]) -> EntityFlags {
    return try! FfiConverterTypeEntityFlags.lift(try! rustCall {
        uniffi_sargon_fn_func_new_entity_flags(
            FfiConverterSequenceTypeEntityFlag.lower(entityFlags), $0
        )
    })
}

public func newEntityFlagsByAppending(entityFlag: EntityFlag, to: EntityFlags) -> EntityFlags {
    return try! FfiConverterTypeEntityFlags.lift(try! rustCall {
        uniffi_sargon_fn_func_new_entity_flags_by_appending(
            FfiConverterTypeEntityFlag.lower(entityFlag),
            FfiConverterTypeEntityFlags.lower(to), $0
        )
    })
}

public func newEntityFlagsRemovedById(idOfEntityFlag: EntityFlag, from: EntityFlags) -> EntityFlags {
    return try! FfiConverterTypeEntityFlags.lift(try! rustCall {
        uniffi_sargon_fn_func_new_entity_flags_removed_by_id(
            FfiConverterTypeEntityFlag.lower(idOfEntityFlag),
            FfiConverterTypeEntityFlags.lower(from), $0
        )
    })
}

public func newEntityFlagsRemovedElement(entityFlag: EntityFlag, from: EntityFlags) -> EntityFlags {
    return try! FfiConverterTypeEntityFlags.lift(try! rustCall {
        uniffi_sargon_fn_func_new_entity_flags_removed_element(
            FfiConverterTypeEntityFlag.lower(entityFlag),
            FfiConverterTypeEntityFlags.lower(from), $0
        )
    })
...
public func newEntityFlagsSample() -> EntityFlags {
    return try! FfiConverterTypeEntityFlags.lift(try! rustCall {
...
public func newEntityFlagsSampleOther() -> EntityFlags {
    return try! FfiConverterTypeEntityFlags.lift(try! rustCall {
...
public func newEntityFlagsWithEntityFlag(entityFlag: EntityFlag) -> EntityFlags {
    return try! FfiConverterTypeEntityFlags.lift(try! rustCall {
        uniffi_sargon_fn_func_new_entity_flags_with_entity_flag(
            FfiConverterTypeEntityFlag.lower(entityFlag), $0
        )
    })
}
...
public func newFactorSources(factorSources: [FactorSource]) throws -> FactorSources {
    return try FfiConverterTypeFactorSources.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_factor_sources(
            FfiConverterSequenceTypeFactorSource.lower(factorSources), $0
        )
    })
}

public func newFactorSourcesByAppending(factorSource: FactorSource, to: FactorSources) -> FactorSources {
    return try! FfiConverterTypeFactorSources.lift(try! rustCall {
        uniffi_sargon_fn_func_new_factor_sources_by_appending(
            FfiConverterTypeFactorSource.lower(factorSource),
            FfiConverterTypeFactorSources.lower(to), $0
        )
    })
}

public func newFactorSourcesRemovedById(idOfFactorSource: FactorSourceId, from: FactorSources) throws -> FactorSources {
    return try FfiConverterTypeFactorSources.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_factor_sources_removed_by_id(
            FfiConverterTypeFactorSourceID.lower(idOfFactorSource),
            FfiConverterTypeFactorSources.lower(from), $0
        )
    })
}

public func newFactorSourcesRemovedElement(factorSource: FactorSource, from: FactorSources) throws -> FactorSources {
    return try FfiConverterTypeFactorSources.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_factor_sources_removed_element(
            FfiConverterTypeFactorSource.lower(factorSource),
            FfiConverterTypeFactorSources.lower(from), $0
        )
    })
...
public func newFactorSourcesSample() -> FactorSources {
    return try! FfiConverterTypeFactorSources.lift(try! rustCall {
...
public func newFactorSourcesSampleOther() -> FactorSources {
    return try! FfiConverterTypeFactorSources.lift(try! rustCall {
...
public func newFactorSourcesWithFactorSource(factorSource: FactorSource) -> FactorSources {
    return try! FfiConverterTypeFactorSources.lift(try! rustCall {
        uniffi_sargon_fn_func_new_factor_sources_with_factor_source(
            FfiConverterTypeFactorSource.lower(factorSource), $0
        )
    })
}
...
public func newGateways(current: Gateway) -> Gateways {
    return try! FfiConverterTypeGateways.lift(try! rustCall {
...
public func newGatewaysChangingCurrent(to: Gateway, gateways: Gateways) throws -> Gateways {
    return try FfiConverterTypeGateways.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_gateways_changing_current(
 ...
 */
public func newGatewaysDefault() -> Gateways {
    return try! FfiConverterTypeGateways.lift(try! rustCall {
        uniffi_sargon_fn_func_new_gateways_default($0
        )
    })
}
 ...
 */
public func newGatewaysSample() -> Gateways {
    return try! FfiConverterTypeGateways.lift(try! rustCall {
 ...
 * A sample value useful for tests and previews.
 */
public func newGatewaysSampleOther() -> Gateways {
    return try! FfiConverterTypeGateways.lift(try! rustCall {
...
public func newOtherGateways(otherGateways: [Gateway]) -> OtherGateways {
    return try! FfiConverterTypeOtherGateways.lift(try! rustCall {
        uniffi_sargon_fn_func_new_other_gateways(
            FfiConverterSequenceTypeGateway.lower(otherGateways), $0
        )
    })
}

public func newOtherGatewaysByAppending(gateway: Gateway, to: OtherGateways) -> OtherGateways {
    return try! FfiConverterTypeOtherGateways.lift(try! rustCall {
        uniffi_sargon_fn_func_new_other_gateways_by_appending(
            FfiConverterTypeGateway.lower(gateway),
            FfiConverterTypeOtherGateways.lower(to), $0
        )
    })
}

public func newOtherGatewaysRemovedById(idOfGateway: Url, from: OtherGateways) -> OtherGateways {
    return try! FfiConverterTypeOtherGateways.lift(try! rustCall {
        uniffi_sargon_fn_func_new_other_gateways_removed_by_id(
            FfiConverterTypeUrl.lower(idOfGateway),
            FfiConverterTypeOtherGateways.lower(from), $0
        )
    })
}

public func newOtherGatewaysRemovedElement(gateway: Gateway, from: OtherGateways) -> OtherGateways {
    return try! FfiConverterTypeOtherGateways.lift(try! rustCall {
        uniffi_sargon_fn_func_new_other_gateways_removed_element(
            FfiConverterTypeGateway.lower(gateway),
            FfiConverterTypeOtherGateways.lower(from), $0
        )
    })
...
public func newOtherGatewaysSample() -> OtherGateways {
    return try! FfiConverterTypeOtherGateways.lift(try! rustCall {
        uniffi_sargon_fn_func_new_other_gateways_sample($0
        )
    })
}

public func newOtherGatewaysSampleOther() -> OtherGateways {
    return try! FfiConverterTypeOtherGateways.lift(try! rustCall {
        uniffi_sargon_fn_func_new_other_gateways_sample_other($0
        )
    })
}

public func newOtherGatewaysWithGateway(gateway: Gateway) -> OtherGateways {
    return try! FfiConverterTypeOtherGateways.lift(try! rustCall {
        uniffi_sargon_fn_func_new_other_gateways_with_gateway(
            FfiConverterTypeGateway.lower(gateway), $0
        )
    })
}

public func newP2PLinks(p2PLinks: [P2pLink]) -> P2pLinks {
    return try! FfiConverterTypeP2PLinks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_p2_p_links(
            FfiConverterSequenceTypeP2PLink.lower(p2PLinks), $0
        )
    })
}

public func newP2PLinksByAppending(p2PLink: P2pLink, to: P2pLinks) -> P2pLinks {
    return try! FfiConverterTypeP2PLinks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_p2_p_links_by_appending(
            FfiConverterTypeP2PLink.lower(p2PLink),
            FfiConverterTypeP2PLinks.lower(to), $0
        )
    })
}

public func newP2PLinksRemovedById(idOfP2PLink: Hash, from: P2pLinks) -> P2pLinks {
    return try! FfiConverterTypeP2PLinks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_p2_p_links_removed_by_id(
            FfiConverterTypeHash.lower(idOfP2PLink),
            FfiConverterTypeP2PLinks.lower(from), $0
        )
    })
}

public func newP2PLinksRemovedElement(p2PLink: P2pLink, from: P2pLinks) -> P2pLinks {
    return try! FfiConverterTypeP2PLinks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_p2_p_links_removed_element(
            FfiConverterTypeP2PLink.lower(p2PLink),
            FfiConverterTypeP2PLinks.lower(from), $0
        )
    })
...
public func newP2PLinksSample() -> P2pLinks {
    return try! FfiConverterTypeP2PLinks.lift(try! rustCall {
...
public func newP2PLinksSampleOther() -> P2pLinks {
    return try! FfiConverterTypeP2PLinks.lift(try! rustCall {
...
public func newP2PLinksWithP2PLink(p2PLink: P2pLink) -> P2pLinks {
    return try! FfiConverterTypeP2PLinks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_p2_p_links_with_p2_p_link(
...
public func newPersonas(personas: [Persona]) -> Personas {
    return try! FfiConverterTypePersonas.lift(try! rustCall {
        uniffi_sargon_fn_func_new_personas(
            FfiConverterSequenceTypePersona.lower(personas), $0
        )
    })
}

public func newPersonasByAppending(persona: Persona, to: Personas) -> Personas {
    return try! FfiConverterTypePersonas.lift(try! rustCall {
        uniffi_sargon_fn_func_new_personas_by_appending(
            FfiConverterTypePersona.lower(persona),
            FfiConverterTypePersonas.lower(to), $0
        )
    })
}

public func newPersonasRemovedById(idOfPersona: IdentityAddress, from: Personas) -> Personas {
    return try! FfiConverterTypePersonas.lift(try! rustCall {
        uniffi_sargon_fn_func_new_personas_removed_by_id(
            FfiConverterTypeIdentityAddress.lower(idOfPersona),
            FfiConverterTypePersonas.lower(from), $0
        )
    })
}

public func newPersonasRemovedElement(persona: Persona, from: Personas) -> Personas {
    return try! FfiConverterTypePersonas.lift(try! rustCall {
        uniffi_sargon_fn_func_new_personas_removed_element(
            FfiConverterTypePersona.lower(persona),
            FfiConverterTypePersonas.lower(from), $0
        )
    })
...
public func newPersonasSample() -> Personas {
    return try! FfiConverterTypePersonas.lift(try! rustCall {
...
public func newPersonasSampleOther() -> Personas {
    return try! FfiConverterTypePersonas.lift(try! rustCall {
...
public func newPersonasWithPersona(persona: Persona) -> Personas {
    return try! FfiConverterTypePersonas.lift(try! rustCall {
        uniffi_sargon_fn_func_new_personas_with_persona(
...
public func newPrivateHdFactorSource(entropy: NonEmptyMax32Bytes, walletClientModel: WalletClientModel) throws -> PrivateHierarchicalDeterministicFactorSource {
...
public func newProfileFromEncryptionBytes(json: BagOfBytes, decryptionPassword: String) throws -> Profile {
    return try FfiConverterTypeProfile.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_profile_from_encryption_bytes(
            FfiConverterTypeBagOfBytes.lower(json),
            FfiConverterString.lower(decryptionPassword), $0
        )
    })
}

public func newProfileFromJsonBytes(jsonBytes: BagOfBytes) throws -> Profile {
    return try FfiConverterTypeProfile.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_profile_from_json_bytes(
            FfiConverterTypeBagOfBytes.lower(jsonBytes), $0
        )
    })
}
...
public func newProfileNetworks(profileNetworks: [ProfileNetwork]) -> ProfileNetworks {
    return try! FfiConverterTypeProfileNetworks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_profile_networks(
            FfiConverterSequenceTypeProfileNetwork.lower(profileNetworks), $0
        )
    })
}

public func newProfileNetworksByAppending(profileNetwork: ProfileNetwork, to: ProfileNetworks) -> ProfileNetworks {
    return try! FfiConverterTypeProfileNetworks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_profile_networks_by_appending(
            FfiConverterTypeProfileNetwork.lower(profileNetwork),
            FfiConverterTypeProfileNetworks.lower(to), $0
        )
    })
}

public func newProfileNetworksRemovedById(idOfProfileNetwork: NetworkId, from: ProfileNetworks) -> ProfileNetworks {
    return try! FfiConverterTypeProfileNetworks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_profile_networks_removed_by_id(
            FfiConverterTypeNetworkID.lower(idOfProfileNetwork),
            FfiConverterTypeProfileNetworks.lower(from), $0
        )
    })
}

public func newProfileNetworksRemovedElement(profileNetwork: ProfileNetwork, from: ProfileNetworks) -> ProfileNetworks {
    return try! FfiConverterTypeProfileNetworks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_profile_networks_removed_element(
            FfiConverterTypeProfileNetwork.lower(profileNetwork),
            FfiConverterTypeProfileNetworks.lower(from), $0
        )
    })
...
public func newProfileNetworksSample() -> ProfileNetworks {
    return try! FfiConverterTypeProfileNetworks.lift(try! rustCall {
...
public func newProfileNetworksSampleOther() -> ProfileNetworks {
    return try! FfiConverterTypeProfileNetworks.lift(try! rustCall {
...
public func newProfileNetworksWithProfileNetwork(profileNetwork: ProfileNetwork) -> ProfileNetworks {
    return try! FfiConverterTypeProfileNetworks.lift(try! rustCall {
        uniffi_sargon_fn_func_new_profile_networks_with_profile_network(
            FfiConverterTypeProfileNetwork.lower(profileNetwork), $0
        )
    })
}
...
public func newSupportedCurves(supportedCurves: [Slip10Curve]) throws -> SupportedCurves {
    return try FfiConverterTypeSupportedCurves.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_supported_curves(
            FfiConverterSequenceTypeSLIP10Curve.lower(supportedCurves), $0
        )
    })
}

public func newSupportedCurvesByAppending(sLIP10Curve: Slip10Curve, to: SupportedCurves) -> SupportedCurves {
    return try! FfiConverterTypeSupportedCurves.lift(try! rustCall {
        uniffi_sargon_fn_func_new_supported_curves_by_appending(
            FfiConverterTypeSLIP10Curve.lower(sLIP10Curve),
            FfiConverterTypeSupportedCurves.lower(to), $0
        )
    })
}

public func newSupportedCurvesRemovedById(idOfSLIP10Curve: String, from: SupportedCurves) throws -> SupportedCurves {
    return try FfiConverterTypeSupportedCurves.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_supported_curves_removed_by_id(
            FfiConverterString.lower(idOfSLIP10Curve),
            FfiConverterTypeSupportedCurves.lower(from), $0
        )
    })
}

public func newSupportedCurvesRemovedElement(sLIP10Curve: Slip10Curve, from: SupportedCurves) throws -> SupportedCurves {
    return try FfiConverterTypeSupportedCurves.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_supported_curves_removed_element(
            FfiConverterTypeSLIP10Curve.lower(sLIP10Curve),
            FfiConverterTypeSupportedCurves.lower(from), $0
        )
    })
...
public func newSupportedCurvesSample() -> SupportedCurves {
    return try! FfiConverterTypeSupportedCurves.lift(try! rustCall {
...
public func newSupportedCurvesSampleOther() -> SupportedCurves {
    return try! FfiConverterTypeSupportedCurves.lift(try! rustCall {
...
public func newSupportedCurvesWithSLIP10Curve(sLIP10Curve: Slip10Curve) -> SupportedCurves {
    return try! FfiConverterTypeSupportedCurves.lift(try! rustCall {
        uniffi_sargon_fn_func_new_supported_curves_with_s_l_i_p10_curve(
...
public func otherGatewaysElementCount(otherGateways: OtherGateways) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_other_gateways_element_count(
            FfiConverterTypeOtherGateways.lower(otherGateways), $0
        )
    })
}

public func otherGatewaysGetElements(otherGateways: OtherGateways) -> [Gateway] {
    return try! FfiConverterSequenceTypeGateway.lift(try! rustCall {
        uniffi_sargon_fn_func_other_gateways_get_elements(
            FfiConverterTypeOtherGateways.lower(otherGateways), $0
        )
    })
}

public func otherGatewaysGetGatewayById(otherGateways: OtherGateways, id: Url) -> Gateway? {
    return try! FfiConverterOptionTypeGateway.lift(try! rustCall {
        uniffi_sargon_fn_func_other_gateways_get_gateway_by_id(
            FfiConverterTypeOtherGateways.lower(otherGateways),
            FfiConverterTypeUrl.lower(id), $0
        )
    })
}

public func p2PLinksElementCount(p2PLinks: P2pLinks) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_p2_p_links_element_count(
            FfiConverterTypeP2PLinks.lower(p2PLinks), $0
        )
    })
}

public func p2PLinksGetElements(p2PLinks: P2pLinks) -> [P2pLink] {
    return try! FfiConverterSequenceTypeP2PLink.lift(try! rustCall {
        uniffi_sargon_fn_func_p2_p_links_get_elements(
            FfiConverterTypeP2PLinks.lower(p2PLinks), $0
        )
    })
}

public func p2PLinksGetP2PLinkById(p2PLinks: P2pLinks, id: Hash) -> P2pLink? {
    return try! FfiConverterOptionTypeP2PLink.lift(try! rustCall {
        uniffi_sargon_fn_func_p2_p_links_get_p2_p_link_by_id(
            FfiConverterTypeP2PLinks.lower(p2PLinks),
            FfiConverterTypeHash.lower(id), $0
        )
    })
}

public func p2pLinkId(link: P2pLink) -> Hash {
    return try! FfiConverterTypeHash.lift(try! rustCall {
...
public func personasElementCount(personas: Personas) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_personas_element_count(
            FfiConverterTypePersonas.lower(personas), $0
        )
    })
}

public func personasGetElements(personas: Personas) -> [Persona] {
    return try! FfiConverterSequenceTypePersona.lift(try! rustCall {
        uniffi_sargon_fn_func_personas_get_elements(
            FfiConverterTypePersonas.lower(personas), $0
        )
    })
}

public func personasGetPersonaById(personas: Personas, id: IdentityAddress) -> Persona? {
    return try! FfiConverterOptionTypePersona.lift(try! rustCall {
        uniffi_sargon_fn_func_personas_get_persona_by_id(
            FfiConverterTypePersonas.lower(personas),
            FfiConverterTypeIdentityAddress.lower(id), $0
        )
    })
}
...
public func profileEncryptWithPassword(profile: Profile, encryptionPassword: String) -> BagOfBytes {
    return try! FfiConverterTypeBagOfBytes.lift(try! rustCall {
...
public func profileNetworksElementCount(profileNetworks: ProfileNetworks) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_profile_networks_element_count(
            FfiConverterTypeProfileNetworks.lower(profileNetworks), $0
        )
    })
}

public func profileNetworksGetElements(profileNetworks: ProfileNetworks) -> [ProfileNetwork] {
    return try! FfiConverterSequenceTypeProfileNetwork.lift(try! rustCall {
        uniffi_sargon_fn_func_profile_networks_get_elements(
            FfiConverterTypeProfileNetworks.lower(profileNetworks), $0
        )
    })
}

public func profileNetworksGetProfileNetworkById(profileNetworks: ProfileNetworks, id: NetworkId) -> ProfileNetwork? {
    return try! FfiConverterOptionTypeProfileNetwork.lift(try! rustCall {
        uniffi_sargon_fn_func_profile_networks_get_profile_network_by_id(
            FfiConverterTypeProfileNetworks.lower(profileNetworks),
            FfiConverterTypeNetworkID.lower(id), $0
        )
    })
}
...
public func profileToJsonBytes(profile: Profile) -> BagOfBytes {
    return try! FfiConverterTypeBagOfBytes.lift(try! rustCall {
        uniffi_sargon_fn_func_profile_to_json_bytes(
            FfiConverterTypeProfile.lower(profile), $0
        )
    })
}
...
public func supportedCurvesElementCount(supportedCurves: SupportedCurves) -> UInt64 {
    return try! FfiConverterUInt64.lift(try! rustCall {
        uniffi_sargon_fn_func_supported_curves_element_count(
            FfiConverterTypeSupportedCurves.lower(supportedCurves), $0
        )
    })
}

public func supportedCurvesGetElements(supportedCurves: SupportedCurves) -> [Slip10Curve] {
    return try! FfiConverterSequenceTypeSLIP10Curve.lift(try! rustCall {
        uniffi_sargon_fn_func_supported_curves_get_elements(
            FfiConverterTypeSupportedCurves.lower(supportedCurves), $0
        )
    })
}

public func supportedCurvesGetSLIP10CurveById(supportedCurves: SupportedCurves, id: String) -> Slip10Curve? {
    return try! FfiConverterOptionTypeSLIP10Curve.lift(try! rustCall {
        uniffi_sargon_fn_func_supported_curves_get_s_l_i_p10_curve_by_id(
            FfiConverterTypeSupportedCurves.lower(supportedCurves),
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_accounts_element_count() != 56839 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_accounts_get_account_by_id() != 63128 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_accounts_get_elements() != 33028 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_authorized_dapps_element_count() != 23647 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_authorized_dapps_get_authorized_dapp_by_id() != 54972 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_authorized_dapps_get_elements() != 2908 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_deposit_rule_to_json_string() != 4322 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_entity_flags_element_count() != 64976 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_entity_flags_get_elements() != 64569 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_entity_flags_get_entity_flag_by_id() != 40649 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_factor_sources_element_count() != 30027 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_factor_sources_get_elements() != 1487 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_factor_sources_get_factor_source_by_id() != 1883 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_gateways_get_all_elements() != 36484 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_hash() != 6269 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_hash_get_bytes() != 5734 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_accounts() != 1408 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_accounts_by_appending() != 54779 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_accounts_removed_by_id() != 35535 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_accounts_removed_element() != 16194 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_accounts_sample() != 29987 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_accounts_sample_other() != 1736 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_accounts_with_account() != 16327 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_authorized_dapps() != 61421 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_authorized_dapps_by_appending() != 36625 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_authorized_dapps_removed_by_id() != 60233 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_authorized_dapps_removed_element() != 55547 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_authorized_dapps_sample() != 37048 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_authorized_dapps_sample_other() != 62780 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_authorized_dapps_with_authorized_dapp() != 3154 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_decimal_from_f32() != 41576 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_decimal_from_f64() != 26527 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_entity_flags() != 27589 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_entity_flags_by_appending() != 48050 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_entity_flags_removed_by_id() != 31014 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_entity_flags_removed_element() != 8421 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_entity_flags_sample() != 46830 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_entity_flags_sample_other() != 20686 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_entity_flags_with_entity_flag() != 4650 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_factor_sources() != 62694 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_factor_sources_by_appending() != 54241 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_factor_sources_removed_by_id() != 44840 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_factor_sources_removed_element() != 54958 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_factor_sources_sample() != 46170 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_factor_sources_sample_other() != 52497 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_factor_sources_with_factor_source() != 8961 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_gateways() != 36922 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_gateways_changing_current() != 48184 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_gateways_default() != 52108 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_gateways_sample() != 47804 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_gateways_sample_other() != 39233 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_other_gateways() != 48782 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_other_gateways_by_appending() != 59672 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_other_gateways_removed_by_id() != 3916 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_other_gateways_removed_element() != 56025 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_other_gateways_sample() != 19833 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_other_gateways_sample_other() != 47292 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_other_gateways_with_gateway() != 47932 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_p2_p_links() != 22902 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_p2_p_links_by_appending() != 56618 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_p2_p_links_removed_by_id() != 50152 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_p2_p_links_removed_element() != 51703 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_p2_p_links_sample() != 59126 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_p2_p_links_sample_other() != 55001 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_p2_p_links_with_p2_p_link() != 58628 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_personas() != 60077 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_personas_by_appending() != 60823 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_personas_removed_by_id() != 62315 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_personas_removed_element() != 53190 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_personas_sample() != 31016 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_personas_sample_other() != 36054 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_personas_with_persona() != 60825 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_private_hd_factor_source() != 52092 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile() != 59141 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile_from_encryption_bytes() != 16158 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile_from_json_bytes() != 36567 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_profile_networks() != 5503 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile_networks_by_appending() != 32799 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile_networks_removed_by_id() != 58262 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile_networks_removed_element() != 57467 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile_networks_sample() != 11820 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile_networks_sample_other() != 36755 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_profile_networks_with_profile_network() != 27933 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_supported_curves() != 25875 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_supported_curves_by_appending() != 54484 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_supported_curves_removed_by_id() != 49352 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_supported_curves_removed_element() != 5359 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_supported_curves_sample() != 4742 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_supported_curves_sample_other() != 17728 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_supported_curves_with_s_l_i_p10_curve() != 21259 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_other_gateways_element_count() != 27132 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_other_gateways_get_elements() != 35698 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_other_gateways_get_gateway_by_id() != 14971 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_p2_p_links_element_count() != 14274 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_p2_p_links_get_elements() != 41780 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_p2_p_links_get_p2_p_link_by_id() != 30447 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_p2p_link_id() != 47826 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_personas_element_count() != 7317 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_personas_get_elements() != 27067 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_personas_get_persona_by_id() != 49151 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_profile_encrypt_with_password() != 28756 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_profile_networks_element_count() != 30616 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_profile_networks_get_elements() != 46300 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_profile_networks_get_profile_network_by_id() != 11168 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_profile_to_debug_string() != 1782 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_profile_to_json_bytes() != 9333 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_supported_curves_element_count() != 39478 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_supported_curves_get_elements() != 51989 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_supported_curves_get_s_l_i_p10_curve_by_id() != 12076 {
        return InitializationResult.apiChecksumMismatch
    }
