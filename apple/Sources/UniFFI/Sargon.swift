...
public struct Exactly29Bytes {
    ...
    // declare one manually.
    fileprivate init(
        secretMagic: Exactly29BytesSecretMagic)
    {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly32Bytes {
    ...
    // declare one manually.
    fileprivate init(
        secretMagic: Exactly32BytesSecretMagic)
    {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly33Bytes {
    ...
    // declare one manually.
    fileprivate init(
        secretMagic: Exactly33BytesSecretMagic)
    {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly64Bytes {
    ...
    // declare one manually.
    fileprivate init(
        secretMagic: Exactly64BytesSecretMagic)
    {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly65Bytes {
    ...
    // declare one manually.
    fileprivate init(
        secretMagic: Exactly65BytesSecretMagic)
    {
        self.secretMagic = secretMagic
    }
}
...
public struct PerAssetTransfers {
    ...
    public init(
        ...
        fungibleResources: [PerAssetTransfersOfFungibleResource],
        nonFungibleResources: [PerAssetTransfersOfNonFungibleResource]
    ) {
...
public struct PerAssetTransfersOfFungibleResource {
    ...
    public init(
        ...
        transfers: [PerAssetFungibleTransfer]
    ) {
...
public struct PerAssetTransfersOfNonFungibleResource {
    ...
    public init(
        ...
        transfers: [PerAssetNonFungibleTransfer]
    ) {
        self.resource = resource
        self.transfers = transfers
    }
...
public struct PerRecipientAssetTransfer {
    ...
    public init(
        recipient: AssetsTransfersRecipient,
        fungibles: [PerRecipientFungibleTransfer],
        nonFungibles: [PerRecipientNonFungiblesTransfer]
    ) {
        self.recipient = recipient
...
public struct PerRecipientAssetTransfers {
    ...
    // declare one manually.
    public init(
        addressOfSender: AccountAddress,
        transfers: [PerRecipientAssetTransfer]
    ) {
...
public func addressOfAccountOrPersonaMapToNetwork(address: AddressOfAccountOrPersona, networkId: NetworkId) -> AddressOfAccountOrPersona {
    return try! FfiConverterTypeAddressOfAccountOrPersona.lift(
        try! rustCall {
...
public func networkIdsAll() -> [NetworkId] {
    return try! FfiConverterSequenceTypeNetworkID.lift(
        try! rustCall {
...
public func newFactorSourceSample() -> FactorSource {
    return try! FfiConverterTypeFactorSource.lift(
        try! rustCall {
...
public func newPerAssetTransfersSample() -> PerAssetTransfers {
    return try! FfiConverterTypePerAssetTransfers.lift(
        try! rustCall {
...
public func newPrivateHdFactorSource(entropy: BagOfBytes, walletClientModel: WalletClientModel) throws -> PrivateHierarchicalDeterministicFactorSource {
    return try FfiConverterTypePrivateHierarchicalDeterministicFactorSource.lift(
        rustCallWithError(FfiConverterTypeCommonError.lift) {
            uniffi_sargon_fn_func_new_private_hd_factor_source(
                FfiConverterTypeBagOfBytes.lower(entropy),
...
public func newPublicKeyHashOfKey(publicKey: PublicKey) -> PublicKeyHash {
    return try! FfiConverterTypePublicKeyHash.lift(
        try! rustCall {
...
public func newStakeClaimSample() -> StakeClaim {
    return try! FfiConverterTypeStakeClaim.lift(
        try! rustCall {
...
public func newThirdPartyDepositsSample() -> ThirdPartyDeposits {
    return try! FfiConverterTypeThirdPartyDeposits.lift(
        try! rustCall {
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_access_controller_address_map_to_network() != 47494 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_account_address_map_to_network() != 27926 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_address_of_account_or_persona_map_to_network() != 22538 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_address_of_account_or_persona_network_id() != 27561 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_address_of_account_or_persona_to_string() != 57052 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_component_address_map_to_network() != 22688 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_decimal_formatted() != 32600 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_decimal_formatted_plain() != 62980 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_decimal_round() != 64835 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_ed25519_public_key_to_bytes() != 49735 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_ed25519_public_key_to_hex() != 58559 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_29_bytes_to_bytes() != 16931 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_29_bytes_to_hex() != 2014 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_32_bytes_to_bytes() != 40844 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_32_bytes_to_hex() != 4269 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_33_bytes_to_bytes() != 35117 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_33_bytes_to_hex() != 59137 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_64_bytes_to_bytes() != 51944 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_64_bytes_to_hex() != 2509 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_65_bytes_to_bytes() != 62561 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_exactly_65_bytes_to_hex() != 37127 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_factor_source_to_string() != 37068 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_identity_address_map_to_network() != 39898 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_manifest_create_multiple_fungible_tokens() != 57117 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_manifest_per_asset_transfers() != 51660 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_manifest_per_recipient_transfers() != 21660 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_network_id_discriminant() != 25528 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_network_id_to_string() != 7986 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_address_of_account_or_persona_from_bech32() != 59872 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_ed25519_public_key_from_bytes() != 22899 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_network_id_from_discriminant() != 53766 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_private_hd_factor_source() != 13009 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_public_key_from_bytes() != 15896 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_public_key_from_hex() != 40918 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_public_key_hash_of_key() != 18654 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_secp256k1_public_key_from_bytes() != 65037 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_non_fungible_resource_address_map_to_network() != 15128 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_package_address_map_to_network() != 43662 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_pool_address_map_to_network() != 2809 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_pool_address_network_id() != 46890 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_profile_to_debug_string() != 20779 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_profile_to_string() != 11282 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_public_key_to_bytes() != 33534 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_public_key_to_hex() != 46695 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_resource_address_map_to_network() != 8860 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_resource_address_network_id() != 38225 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_secp256k1_public_key_to_bytes() != 10351 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_secp256k1_public_key_to_bytes_uncompressed() != 47988 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_transaction_manifest_blobs() != 5019 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_transaction_manifest_instructions_string() != 33186 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_transaction_manifest_network_id() != 50903 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_validator_address_bech32_address() != 31829 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_validator_address_map_to_network() != 35420 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_vault_address_map_to_network() != 64125 {
        return InitializationResult.apiChecksumMismatch
    }
