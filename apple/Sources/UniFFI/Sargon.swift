...
public struct FfiConverterTypeTransactionManifestSecretMagic: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> TransactionManifestSecretMagic {
        return
            try TransactionManifestSecretMagic(
                ...
                blobs: FfiConverterSequenceTypeBagOfBytes.read(from: &buf)
            )
    }
    ...
    public static func write(_ value: TransactionManifestSecretMagic, into buf: inout [UInt8]) {
        ...
        FfiConverterSequenceTypeBagOfBytes.write(value.blobs, into: &buf)
    }
}
...
private struct FfiConverterSequenceTypeBagOfBytes: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [BagOfBytes] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            try seq.append(FfiConverterTypeBagOfBytes.read(from: &buf))
        }
        return seq
    }
}
...
public func newTransactionManifestFromInstructionsStringAndBlobs(instructionsString: String, networkId: NetworkId, blobs: [BagOfBytes]) throws -> TransactionManifest {
    return try FfiConverterTypeTransactionManifest.lift(
        rustCallWithError(FfiConverterTypeCommonError.lift) {
            uniffi_sargon_fn_func_new_transaction_manifest_from_instructions_string_and_blobs(
                ...
                FfiConverterTypeNetworkID.lower(networkId),
                FfiConverterSequenceTypeBagOfBytes.lower(blobs), $0
            )
        }
    )
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_new_transaction_manifest_from_instructions_string_and_blobs() != 38243 {
        return InitializationResult.apiChecksumMismatch
    }
