...
public struct ExecutionSummary {
     ...
     */
    public var addressesOfAccountsWithdrawnFrom: [AccountAddress: [ResourceIndicator]]
    /**
     * Addresses of accounts deposited into in the manifest.
     */
    public var addressesOfAccountsDepositedInto: [AccountAddress: [ResourceIndicator]]
    /**
    ...
    public init(
         ...
         * Addresses of accounts withdraws from in the manifest.
         */
        addressesOfAccountsWithdrawnFrom: [AccountAddress: [ResourceIndicator]],
        /**
            * Addresses of accounts deposited into in the manifest.
            */
        addressesOfAccountsDepositedInto: [AccountAddress: [ResourceIndicator]],
        /**
            * Addresses of accounts encountered in the manifest where privileged
            * methods were called.
            */
...
public struct FfiConverterTypeExecutionSummary: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ExecutionSummary {
        return
            try ExecutionSummary(
                addressesOfAccountsWithdrawnFrom: FfiConverterDictionaryTypeAccountAddressSequenceTypeResourceIndicator.read(from: &buf),
                addressesOfAccountsDepositedInto: FfiConverterDictionaryTypeAccountAddressSequenceTypeResourceIndicator.read(from: &buf),
    ...
    public static func write(_ value: ExecutionSummary, into buf: inout [UInt8]) {
        FfiConverterDictionaryTypeAccountAddressSequenceTypeResourceIndicator.write(value.addressesOfAccountsWithdrawnFrom, into: &buf)
        FfiConverterDictionaryTypeAccountAddressSequenceTypeResourceIndicator.write(value.addressesOfAccountsDepositedInto, into: &buf)
...
public struct NewEntities {
    ...
    // declare one manually.
    public init(
        metadata: [ResourceAddress: NewlyCreatedResource])
    {
...
public struct TrackedPoolContribution {
    ...
    public init(
        ...
        contributedResources: [ResourceAddress: Decimal192],
        poolUnitsResourceAddress: ResourceAddress,
        poolUnitsAmount: Decimal192
    ) {
...
public struct TrackedPoolRedemption {
    ...
    public init(
        ...
        poolUnitsResourceAddress: ResourceAddress,
        poolUnitsAmount: Decimal192,
        redeemedResources: [ResourceAddress: Decimal192]
    ) {
        self.poolAddress = poolAddress
        self.poolUnitsResourceAddress = poolUnitsResourceAddress
        self.poolUnitsAmount = poolUnitsAmount
...
public struct TrackedValidatorClaim {
    ...
    public init(
        validatorAddress: ValidatorAddress,
        claimNftAddress: ResourceAddress,
...
public struct TrackedValidatorStake {
    ...
    public init(
        validatorAddress: ValidatorAddress,
        xrdAmount: Decimal192,
        liquidStakeUnitAddress: ResourceAddress,
        liquidStakeUnitAmount: Decimal192
    ) {
        self.validatorAddress = validatorAddress
        self.xrdAmount = xrdAmount
...
public struct TransactionGuarantee {
    ...
    public var instructionIndex: UInt64
    public var resourceAddress: ResourceAddress
    public var resourceDivisibility: Int32?
...
public struct FfiConverterTypeTransactionGuarantee: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> TransactionGuarantee {
        return
            try TransactionGuarantee(
                ...
                instructionIndex: FfiConverterUInt64.read(from: &buf),
                resourceAddress: FfiConverterTypeResourceAddress.read(from: &buf),
                resourceDivisibility: FfiConverterOptionInt32.read(from: &buf)
            )
    }
    ...
    public static func write(_ value: TransactionGuarantee, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt64.write(value.instructionIndex, into: &buf)
        FfiConverterTypeResourceAddress.write(value.resourceAddress, into: &buf)
        FfiConverterOptionInt32.write(value.resourceDivisibility, into: &buf)
    }
}
...
public enum CommonError {
    ...
    case DecimalOverflow(message: String)
...
public struct FfiConverterTypeCommonError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CommonError {
        ...
        case 107: return try .DecimalOverflow(
                message: FfiConverterString.read(from: &buf)
            )
    ...
    public static func write(_ value: CommonError, into buf: inout [UInt8]) {
        ...
        case .DecimalOverflow(_ /* message is ignored*/ ):
...
public struct FfiConverterTypeDetailedManifestClass: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DetailedManifestClass {
        ...
        case 2: return try .transfer(
                isOneToOne: FfiConverterBool.read(from: &buf)
            )
        ...
        case 5: return try .validatorUnstake(
                validatorAddresses: FfiConverterSequenceTypeValidatorAddress.read(from: &buf),
                claimsNonFungibleData: FfiConverterDictionaryTypeNonFungibleGlobalIdTypeUnstakeData.read(from: &buf)
            )
        ...
        case 7: return try .poolContribution(
                poolAddresses: FfiConverterSequenceTypePoolAddress.read(from: &buf),
...
public enum FungibleResourceIndicator {
    ...
    case predicted(
        predictedDecimal: PredictedDecimal
    )
}
...
public struct FfiConverterTypeFungibleResourceIndicator: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FungibleResourceIndicator {
        ...
        case 1: return try .guaranteed(
                decimal: FfiConverterTypeDecimal192.read(from: &buf)
            )

        case 2: return try .predicted(
                predictedDecimal: FfiConverterTypePredictedDecimal.read(from: &buf)
            )
...
public enum NonFungibleResourceIndicator {
    case byAll(
        ...
        predictedIds: PredictedNonFungibleLocalIds
    )
    case byAmount(
        amount: Decimal192,
        predictedIds: PredictedNonFungibleLocalIds
...
public struct FfiConverterTypeNonFungibleResourceIndicator: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NonFungibleResourceIndicator {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .byAll(
                predictedAmount: FfiConverterTypePredictedDecimal.read(from: &buf),
                predictedIds: FfiConverterTypePredictedNonFungibleLocalIds.read(from: &buf)
            )

        case 2: return try .byAmount(
                amount: FfiConverterTypeDecimal192.read(from: &buf),
                predictedIds: FfiConverterTypePredictedNonFungibleLocalIds.read(from: &buf)
            )

        case 3: return try .byIds(
                ids: FfiConverterSequenceTypeNonFungibleLocalId.read(from: &buf)
            )
...
public struct FfiConverterTypeResourceIndicator: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ResourceIndicator {
        ...
        case 1: return try .fungible(
                resourceAddress: FfiConverterTypeResourceAddress.read(from: &buf),
                indicator: FfiConverterTypeFungibleResourceIndicator.read(from: &buf)
            )

        case 2: return try .nonFungible(
                resourceAddress: FfiConverterTypeResourceAddress.read(from: &buf),
                indicator: FfiConverterTypeNonFungibleResourceIndicator.read(from: &buf)
            )
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_manifest_third_party_deposit_update() != 29944 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_mnemonic_phrase() != 1392 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_modify_manifest_add_guarantees() != 43033 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_modify_manifest_lock_fee() != 24667 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_decimal_from_f32() != 5444 {
        return InitializationResult.apiChecksumMismatch
    }
