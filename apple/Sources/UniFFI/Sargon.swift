...
extension CompiledNotarizedIntent: Equatable, Hashable {
    public static func == (_: CompiledNotarizedIntent, _: CompiledNotarizedIntent) -> Bool {
        return true
    }
...
public struct FfiConverterTypeCompiledNotarizedIntent: FfiConverterRustBuffer {
    public static func read(from _: inout (data: Data, offset: Data.Index)) throws -> CompiledNotarizedIntent {
        return
            CompiledNotarizedIntent()
    }

    public static func write(_: CompiledNotarizedIntent, into _: inout [UInt8]) {}
}
...
public func debugPrintCompiledNotarizedIntent(data: CompiledNotarizedIntent) -> String {
    return try! FfiConverterString.lift(
        try! rustCall {
            uniffi_sargon_fn_func_debug_print_compiled_notarized_intent(
                FfiConverterTypeCompiledNotarizedIntent.lower(data), $0
            )
        }
    )
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_debug_print_compiled_notarized_intent() != 24626 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_manifest_create_multiple_non_fungible_tokens() != 36786 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_manifest_stakes_claim() != 43638 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_xrd_address_of_network() != 28387 {
        return InitializationResult.apiChecksumMismatch
    }
