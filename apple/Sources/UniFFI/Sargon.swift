...
public func profileToJsonBytes(profile: Profile) throws -> BagOfBytes {
    return try FfiConverterTypeBagOfBytes.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_profile_to_json_bytes() != 63076 {
        return InitializationResult.apiChecksumMismatch
    }
