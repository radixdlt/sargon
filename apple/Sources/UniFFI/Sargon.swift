...
public struct Nonce {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: NonceSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
extension AssetsTransfersRecipient: Sendable {}
...
public enum CommonError {
    ...
    case FailedToParseSignatureFromBytes(message: String)
}
...
public struct FfiConverterTypeCommonError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: CommonError, into buf: inout [UInt8]) {
        ...
        case .FailedToParseSignatureFromBytes(_ /* message is ignored*/ ):
...
public func assetsTransfersRecipientAccountAddress(recipient: AssetsTransfersRecipient) -> AccountAddress {
    return try! FfiConverterTypeAccountAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_assets_transfers_recipient_account_address(
            FfiConverterTypeAssetsTransfersRecipient.lower(recipient), $0
        )
    })
}
 ...
 */
public func newAccessControllerAddressSampleRandom(networkId: NetworkId) -> AccessControllerAddress {
    return try! FfiConverterTypeAccessControllerAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_access_controller_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
 ...
 * Returns a random address in `network_id` as Network
 */
public func newAccountAddressSampleRandom(networkId: NetworkId) -> AccountAddress {
    return try! FfiConverterTypeAccountAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_account_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
...
public func newAssetsTransfersRecipientSample() -> AssetsTransfersRecipient {
    return try! FfiConverterTypeAssetsTransfersRecipient.lift(try! rustCall {
        uniffi_sargon_fn_func_new_assets_transfers_recipient_sample($0
        )
    })
}

public func newAssetsTransfersRecipientSampleOther() -> AssetsTransfersRecipient {
    return try! FfiConverterTypeAssetsTransfersRecipient.lift(try! rustCall {
        uniffi_sargon_fn_func_new_assets_transfers_recipient_sample_other($0
        )
    })
}
 ...
 * Returns a random address in `network_id` as Network
 */
public func newComponentAddressSampleRandom(networkId: NetworkId) -> ComponentAddress {
    return try! FfiConverterTypeComponentAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_component_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
 ...
 * Returns a random address in `network_id` as Network
 */
public func newIdentityAddressSampleRandom(networkId: NetworkId) -> IdentityAddress {
    return try! FfiConverterTypeIdentityAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_identity_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
 ...
 * Returns a random address in `network_id` as Network
 */
public func newPackageAddressSampleRandom(networkId: NetworkId) -> PackageAddress {
    return try! FfiConverterTypePackageAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_package_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
 ...
 * Returns a random address in `network_id` as Network
 */
public func newPoolAddressSampleRandom(networkId: NetworkId) -> PoolAddress {
    return try! FfiConverterTypePoolAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_pool_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
 ...
 * Returns a random address in `network_id` as Network
 */
public func newResourceAddressSampleRandom(networkId: NetworkId) -> ResourceAddress {
    return try! FfiConverterTypeResourceAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_resource_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
 ...
 * Returns a random address in `network_id` as Network
 */
public func newValidatorAddressSampleRandom(networkId: NetworkId) -> ValidatorAddress {
    return try! FfiConverterTypeValidatorAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_validator_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
 ...
 * Returns a random address in `network_id` as Network
 */
public func newVaultAddressSampleRandom(networkId: NetworkId) -> VaultAddress {
    return try! FfiConverterTypeVaultAddress.lift(try! rustCall {
        uniffi_sargon_fn_func_new_vault_address_sample_random(
            FfiConverterTypeNetworkID.lower(networkId), $0
        )
    })
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_assets_transfers_recipient_account_address() != 19674 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_access_controller_address_sample_random() != 30336 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_account_address_sample_random() != 64498 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_assets_transfers_recipient_sample() != 51514 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_assets_transfers_recipient_sample_other() != 44610 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_component_address_sample_random() != 61156 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_identity_address_sample_random() != 26999 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_package_address_sample_random() != 59643 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_pool_address_sample_random() != 36169 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_resource_address_sample_random() != 11420 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_validator_address_sample_random() != 19574 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_vault_address_sample_random() != 47775 {
        return InitializationResult.apiChecksumMismatch
    }
