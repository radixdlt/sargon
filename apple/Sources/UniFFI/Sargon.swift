...
public enum CommonError {
    ...
    case InvalidIntentFailedToEncode(message: String)

    case InvalidInstructionsFailedToDecompile(message: String)

    case InvalidTransactionMaxSborDepthExceeded(message: String)

    case InvalidSignedIntentFailedToEncode(message: String)

    case InvalidNotarizedIntentFailedToEncode(message: String)
}
...
public struct FfiConverterTypeCommonError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: CommonError, into buf: inout [UInt8]) {
        ...
        case .InvalidIntentFailedToEncode(_ /* message is ignored*/ ):
            writeInt(&buf, Int32(110))
        case .InvalidInstructionsFailedToDecompile(_ /* message is ignored*/ ):
            writeInt(&buf, Int32(111))
        case .InvalidTransactionMaxSborDepthExceeded(_ /* message is ignored*/ ):
            writeInt(&buf, Int32(112))
        case .InvalidSignedIntentFailedToEncode(_ /* message is ignored*/ ):
            writeInt(&buf, Int32(113))
        case .InvalidNotarizedIntentFailedToEncode(_ /* message is ignored*/ ):
