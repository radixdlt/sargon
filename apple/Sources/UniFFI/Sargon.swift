 ...
 */
public func decimalFormattedEngineeringNotation(decimal: Decimal192, locale: LocaleConfig, totalPlaces: UInt8?) -> String {
    return try! FfiConverterString.lift(
        try! rustCall {
            uniffi_sargon_fn_func_decimal_formatted_engineering_notation(
                FfiConverterTypeDecimal192.lower(decimal),
                FfiConverterTypeLocaleConfig.lower(locale),
                FfiConverterOptionUInt8.lower(totalPlaces), $0
            )
        }
    )
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_decimal_formatted_engineering_notation() != 40230 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_secp256k1_public_key_from_bytes() != 59642 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_secp256k1_public_key_to_bytes() != 3858 {
        return InitializationResult.apiChecksumMismatch
    }
