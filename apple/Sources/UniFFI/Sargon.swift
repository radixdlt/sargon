...
public struct PersonaDataEntryName {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(variant: Variant, familyName: String, givenNames: String, nickname: String) {
...
public func newSampleAuthorisedDappMainnetDashboard() -> AuthorizedDapp {
    return try! FfiConverterTypeAuthorizedDapp.lift(try! rustCall {
        uniffi_sargon_fn_func_new_sample_authorised_dapp_mainnet_dashboard($0
        )
    })
}

public func newSampleAuthorisedDappMainnetGumballclub() -> AuthorizedDapp {
    return try! FfiConverterTypeAuthorizedDapp.lift(try! rustCall {
        uniffi_sargon_fn_func_new_sample_authorised_dapp_mainnet_gumballclub($0
        )
    })
}

public func newSampleAuthorisedDappStokenetDevconsole() -> AuthorizedDapp {
    return try! FfiConverterTypeAuthorizedDapp.lift(try! rustCall {
        uniffi_sargon_fn_func_new_sample_authorised_dapp_stokenet_devconsole($0
        )
    })
}

public func newSampleAuthorisedDappStokenetSandbox() -> AuthorizedDapp {
    return try! FfiConverterTypeAuthorizedDapp.lift(try! rustCall {
        uniffi_sargon_fn_func_new_sample_authorised_dapp_stokenet_sandbox($0
        )
    })
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_get_accounts() != 19663 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_get_authorized_dapps() != 34559 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_get_factor_sources() != 17448 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_get_other_gateways() != 64483 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_get_personas() != 13589 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_get_supported_curves() != 56591 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_sample_authorised_dapp_mainnet_dashboard() != 9157 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_sample_authorised_dapp_mainnet_gumballclub() != 12419 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_sample_authorised_dapp_stokenet_devconsole() != 37165 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_new_sample_authorised_dapp_stokenet_sandbox() != 64112 {
        return InitializationResult.apiChecksumMismatch
    }
