    ...
    SecureStorage
{
    ...
    open func saveData(key: SecureStorageKey, data: Data) throws {
        try
            rustCallWithError(FfiConverterTypeCommonError.lift) {
    ...
    open func deleteDataForKey(key: SecureStorageKey) throws {
        try
            rustCallWithError(FfiConverterTypeCommonError.lift) {
    ...
    WalletProtocol
{
     ...
     * error is returned.
     */
    open func addAccount(account: Account) throws {
        try
            rustCallWithError(FfiConverterTypeCommonError.lift) {
...
public struct AccessControllerAddress {
    ...
    public init(secretMagic: RetAccessControllerAddress) {
...
public struct AccountAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: RetAccountAddress) {
        self.secretMagic = secretMagic
    }
}
...
public struct Blob {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: BagOfBytes) {
        self.secretMagic = secretMagic
    }
}
...
public struct Blobs {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: BlobsSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct ComponentAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: RetComponentAddress) {
        self.secretMagic = secretMagic
    }
}
...
public struct Decimal192 {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: ScryptoDecimal192) {
        self.secretMagic = secretMagic
    }
}
...
public struct Ed25519PublicKey {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: ScryptoEd25519PublicKey) {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly29Bytes {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: Exactly29BytesSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly32Bytes {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: Exactly32BytesSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly33Bytes {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: Exactly33BytesSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly64Bytes {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: Exactly64BytesSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct Exactly65Bytes {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: Exactly65BytesSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct Hash {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: HashSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct IdentityAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: RetIdentityAddress) {
        self.secretMagic = secretMagic
    }
}
...
public struct Instructions {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: InstructionsSecretMagic, networkId: NetworkId) {
        self.secretMagic = secretMagic
        self.networkId = networkId
    }
}
...
public struct IntentSignature {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: SignatureWithPublicKey) {
        self.secretMagic = secretMagic
    }
}
...
public struct LegacyOlympiaAccountAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: LegacyOlympiaAccountAddressSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct NonFungibleLocalIdString {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: ScryptoStringNonFungibleLocalId) {
        self.secretMagic = secretMagic
    }
}
...
public struct NonFungibleResourceAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: ResourceAddress) {
        self.secretMagic = secretMagic
    }
}
...
public struct NotarySignature {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: Signature) {
        self.secretMagic = secretMagic
    }
}
...
public struct PackageAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: RetPackageAddress) {
        self.secretMagic = secretMagic
    }
}
...
public struct PerRecipientAssetTransfer {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(recipient: AssetsTransfersRecipient, fungibles: [PerRecipientFungibleTransfer], nonFungibles: [PerRecipientNonFungiblesTransfer]) {
        self.recipient = recipient
...
public struct PoolAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: RetPoolAddress) {
        self.secretMagic = secretMagic
    }
}
...
public struct ResourceAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: RetResourceAddress) {
        self.secretMagic = secretMagic
    }
}
...
public struct Secp256k1PublicKey {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: ScryptoSecp256k1PublicKey) {
        self.secretMagic = secretMagic
    }
}
...
public struct TransactionManifest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: TransactionManifestSecretMagic) {
        self.secretMagic = secretMagic
    }
}
...
public struct ValidatorAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: RetValidatorAddress) {
        self.secretMagic = secretMagic
    }
}
...
public struct VaultAddress {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(secretMagic: RetVaultAddress) {
        self.secretMagic = secretMagic
    }
}
...
public enum AddressOfAccountOrPersona {
    ...
    case persona(address: IdentityAddress
    )
}
...
public struct FfiConverterTypeAddressOfAccountOrPersona: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AddressOfAccountOrPersona {
        ...
        switch variant {
        case 1: return try .account(address: FfiConverterTypeAccountAddress.read(from: &buf)
            )

        case 2: return try .persona(address: FfiConverterTypeIdentityAddress.read(from: &buf)
            )
...
public enum AssetsTransfersRecipient {
    case myOwnAccount(value: Account
    )
    case foreignAccount(value: AccountAddress
    )
}
...
public struct FfiConverterTypeAssetsTransfersRecipient: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AssetsTransfersRecipient {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .myOwnAccount(value: FfiConverterTypeAccount.read(from: &buf)
            )

        case 2: return try .foreignAccount(value: FfiConverterTypeAccountAddress.read(from: &buf)
            )
...
public enum CommonError {
    ...
    case InvalidAddressNotOlympiaMainnet(message: String)
}
...
public struct FfiConverterTypeCommonError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: CommonError, into buf: inout [UInt8]) {
        ...
        case .InvalidAddressNotOlympiaMainnet(_ /* message is ignored*/ ):
...
public struct FfiConverterTypeDependencyInformation: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DependencyInformation {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .version(value: FfiConverterString.read(from: &buf)
            )

        case 2: return try .tag(value: FfiConverterString.read(from: &buf)
            )

        case 3: return try .branch(value: FfiConverterString.read(from: &buf)
            )

        case 4: return try .rev(value: FfiConverterString.read(from: &buf)
            )
...
public struct FfiConverterTypeDetailedManifestClass: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DetailedManifestClass {
        ...
        case 8: return try .poolRedemption(poolAddresses: FfiConverterSequenceTypePoolAddress.read(from: &buf), poolContributions: FfiConverterSequenceTypeTrackedPoolRedemption.read(from: &buf))
...
public enum PublicKey {
     ...
     */
    case ed25519(value: Ed25519PublicKey
    )
    /**
     * A secp256k1 public key used to verify cryptographic signatures (ECDSA signatures).
     */
    case secp256k1(value: Secp256k1PublicKey
    )
}
...
public struct FfiConverterTypePublicKey: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PublicKey {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .ed25519(value: FfiConverterTypeEd25519PublicKey.read(from: &buf)
            )

        case 2: return try .secp256k1(value: FfiConverterTypeSecp256k1PublicKey.read(from: &buf)
            )
...
public func defaultGetIdPath() -> GetIdPath {
    return try! FfiConverterTypeGetIDPath.lift(
        try! rustCall {
...
public func newAccountPathSample() -> AccountPath {
    return try! FfiConverterTypeAccountPath.lift(
        try! rustCall {
...
public func newBip44LikePathFromString(string: String) throws -> Bip44LikePath {
    return try FfiConverterTypeBIP44LikePath.lift(
        rustCallWithError(FfiConverterTypeCommonError.lift) {
...
public func newCap26PathFromString(string: String) throws -> Cap26Path {
    return try FfiConverterTypeCAP26Path.lift(
        rustCallWithError(FfiConverterTypeCommonError.lift) {
...
public func newIdentityPathSample() -> IdentityPath {
    return try! FfiConverterTypeIdentityPath.lift(
        try! rustCall {
...
public func newIntentSignatureFromSignatureWithPublicKey(signatureWithPublicKey: SignatureWithPublicKey) -> IntentSignature {
    return try! FfiConverterTypeIntentSignature.lift(
        try! rustCall {
...
public func newLegacyOlympiaAccountAddressFromPublicKey(publicKey: Secp256k1PublicKey) -> LegacyOlympiaAccountAddress {
    return try! FfiConverterTypeLegacyOlympiaAccountAddress.lift(
        try! rustCall {
...
public func transactionManifestInvolvedPoolAddresses(manifest: TransactionManifest) -> [PoolAddress] {
    return try! FfiConverterSequenceTypePoolAddress.lift(
        try! rustCall {
...
public func transactionManifestInvolvedResourceAddresses(manifest: TransactionManifest) -> [ResourceAddress] {
    return try! FfiConverterSequenceTypeResourceAddress.lift(
        try! rustCall {
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_account_address_to_short() != 23892 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_address_of_account_or_persona_map_to_network() != 59125 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_address_of_account_or_persona_network_id() != 34645 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_address_of_account_or_persona_to_string() != 16640 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_manifest_create_multiple_fungible_tokens() != 5139 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_manifest_create_multiple_non_fungible_tokens() != 62240 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_func_manifest_create_non_fungible_token() != 8239 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_func_new_address_of_account_or_persona_from_bech32() != 26483 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_constructor_wallet_by_creating_new_profile_and_secrets_with_entropy() != 17263 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_constructor_wallet_by_importing_profile() != 12528 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_constructor_wallet_by_loading_profile() != 11339 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_constructor_wallet_by_loading_profile_with_id() != 23108 {
        return InitializationResult.apiChecksumMismatch
    }
