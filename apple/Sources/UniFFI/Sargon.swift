...
public func newProfileFromJsonBytes(json: BagOfBytes) throws -> Profile {
    return try FfiConverterTypeProfile.lift(rustCallWithError(FfiConverterTypeCommonError.lift) {
        uniffi_sargon_fn_func_new_profile_from_json_bytes(
            FfiConverterTypeBagOfBytes.lower(json), $0
        )
    })
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_func_new_profile_from_json_bytes() != 65343 {
        return InitializationResult.apiChecksumMismatch
    }
