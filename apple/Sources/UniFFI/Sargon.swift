...
public protocol GatewayClientProtocol: AnyObject {
    ...
    func transactionDryRun(intent: TransactionIntent, signerPublicKeys: [PublicKey]) async throws -> BagOfBytes
    ...
    GatewayClientProtocol
{
    ...
    open func transactionDryRun(intent: TransactionIntent, signerPublicKeys: [PublicKey]) async throws -> BagOfBytes {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_sargon_fn_method_gatewayclient_transaction_dry_run(
                        self.uniffiClonePointer(),
...
public protocol NetworkAntenna: AnyObject {
    func makeRequest(request: NetworkRequest) async throws -> NetworkResponse
}
    ...
    NetworkAntenna
{
    ...
    open func makeRequest(request: NetworkRequest) async throws -> NetworkResponse {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_sargon_fn_method_networkantenna_make_request(
                        self.uniffiClonePointer(),
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_sargon_checksum_method_gatewayclient_current_epoch() != 22978 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_method_gatewayclient_transaction_dry_run() != 29159 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_method_gatewayclient_xrd_balance_of_account() != 20714 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_method_gatewayclient_xrd_balance_of_account_or_zero() != 57946 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_method_networkantenna_make_request() != 33089 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_sargon_checksum_constructor_gatewayclient_new() != 9857 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_sargon_checksum_constructor_gatewayclient_with_gateway() != 16873 {
        return InitializationResult.apiChecksumMismatch
    }
