...
pub struct RnsDomainDetails {
    ...
    /// The owner of the domain determined from the domain's NFT data.
    pub owner: AccountAddress,
    /// The start color of the gradient for the domain's visual representation.
...
mod tests {
    ...
    fn test_try_from_valid() {
        ...
        let details = RnsDomainDetails::try_from(scrypto_value)
