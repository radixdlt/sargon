...
impl From<InternalPerRecipientAssetTransfers> for PerRecipientAssetTransfers {
    fn from(
        per_recipient_asset_transfers: InternalPerRecipientAssetTransfers,
    ) -> Self {
        Self {
            address_of_sender: per_recipient_asset_transfers
                .address_of_sender
                .into(),
            transfers: per_recipient_asset_transfers.transfers.into_vec(),
        }
    }
}
