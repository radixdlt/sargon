...
impl From<InternalDappToWalletInteractionUnauthorizedRequestItems>
    for DappToWalletInteractionUnauthorizedRequestItems
{
    fn from(
        value: InternalDappToWalletInteractionUnauthorizedRequestItems,
    ) -> Self {
        Self {
...
impl Into<InternalDappToWalletInteractionUnauthorizedRequestItems>
    for DappToWalletInteractionUnauthorizedRequestItems
{
