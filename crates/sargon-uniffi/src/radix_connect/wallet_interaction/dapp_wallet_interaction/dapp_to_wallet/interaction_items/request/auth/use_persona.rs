...
impl From<InternalDappToWalletInteractionAuthUsePersonaRequestItem>
    for DappToWalletInteractionAuthUsePersonaRequestItem
{
    fn from(
        value: InternalDappToWalletInteractionAuthUsePersonaRequestItem,
    ) -> Self {
        Self {
...
impl Into<InternalDappToWalletInteractionAuthUsePersonaRequestItem>
    for DappToWalletInteractionAuthUsePersonaRequestItem
{
