...
impl From<InternalWalletToDappInteractionAuthUsePersonaRequestResponseItem>
    for WalletToDappInteractionAuthUsePersonaRequestResponseItem
{
    fn from(
        value: InternalWalletToDappInteractionAuthUsePersonaRequestResponseItem,
    ) -> Self {
        Self {
...
impl Into<InternalWalletToDappInteractionAuthUsePersonaRequestResponseItem>
    for WalletToDappInteractionAuthUsePersonaRequestResponseItem
{
    fn into(
        self,
