...
impl From<InternalWalletToDappInteractionFailureResponse>
    for WalletToDappInteractionFailureResponse
{
...
impl Into<InternalWalletToDappInteractionFailureResponse>
    for WalletToDappInteractionFailureResponse
{
