...
impl TransactionSignRequestInputForSubintent {
    pub fn into_internal(&self) -> InternalTransactionSignRequestInputForSubintent {
        self.clone().into()
    }
}

impl From<InternalTransactionSignRequestInputForSubintent> for TransactionSignRequestInputForSubintent {
...
impl From<TransactionSignRequestInputForSubintent> for InternalTransactionSignRequestInputForSubintent {
...
#[uniffi::export]
pub fn new_transaction_sign_request_input_for_subintent_sample() -> TransactionSignRequestInputForSubintent {
    InternalTransactionSignRequestInputForSubintent::sample().into()
}

#[uniffi::export]
pub fn new_transaction_sign_request_input_for_subintent_sample_other() -> TransactionSignRequestInputForSubintent {
