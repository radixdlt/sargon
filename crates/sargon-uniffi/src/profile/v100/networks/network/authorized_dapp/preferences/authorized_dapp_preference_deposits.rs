...
impl From<InternalAuthorizedDappPreferenceDeposits>
    for AuthorizedDappPreferenceDeposits
{
    fn from(value: InternalAuthorizedDappPreferenceDeposits) -> Self {
        match value {
            InternalAuthorizedDappPreferenceDeposits::Hidden => {
                AuthorizedDappPreferenceDeposits::Hidden
            }
            InternalAuthorizedDappPreferenceDeposits::Visible => {
...
impl Into<InternalAuthorizedDappPreferenceDeposits>
    for AuthorizedDappPreferenceDeposits
{
