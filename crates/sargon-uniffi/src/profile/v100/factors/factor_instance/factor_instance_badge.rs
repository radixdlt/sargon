...
impl From<InternalFactorInstanceBadge> for FactorInstanceBadge {
    fn from(value: InternalFactorInstanceBadge) -> Self {
        match value {
            InternalFactorInstanceBadge::Virtual { value } => FactorInstanceBadge::Virtual {
                value: value.into(),
            },
            InternalFactorInstanceBadge::Physical { value } => FactorInstanceBadge::Physical {
                value: value.into(),
            },
        }
    }
...
impl Into<InternalFactorInstanceBadge> for FactorInstanceBadge {
    fn into(self) -> InternalFactorInstanceBadge {
        match self {
            FactorInstanceBadge::Virtual { value } => InternalFactorInstanceBadge::Virtual {
                value: value.into(),
            },
            FactorInstanceBadge::Physical { value } => InternalFactorInstanceBadge::Physical {
                value: value.into(),
            },
        }
    }
