...
impl From<InternalSecurity> for Security {
    fn from(value: InternalSecurity) -> Self {
        Self {
            is_cloud_profile_sync_enabled: value.is_cloud_profile_sync_enabled.0,
...
impl Into<InternalSecurity> for Security {
    fn into(self) -> InternalSecurity {
        InternalSecurity {
            is_cloud_profile_sync_enabled: IsCloudProfileSyncEnabled(self.is_cloud_profile_sync_enabled),
            is_developer_mode_enabled: IsDeveloperModeEnabled(self.is_developer_mode_enabled),
            is_advanced_lock_enabled: IsAdvancedLockEnabled(self.is_advanced_lock_enabled),
