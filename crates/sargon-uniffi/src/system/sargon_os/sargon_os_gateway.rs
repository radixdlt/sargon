...
impl SargonOS {
    ...
    pub fn current_network_id(&self) -> Result<NetworkID> {
        self.wrapped.current_network_id()
    }
...
impl SargonOS {
    ...
    pub async fn change_current_gateway(
        ...
        self.wrapped.change_current_gateway(to).await
    }
}