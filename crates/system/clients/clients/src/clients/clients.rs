...
pub struct Clients {
    ...
    pub save_intents_to_confirm_after_delay:
...
impl Clients {
    pub fn with_drivers(drivers: Arc<Drivers>) -> Self {
        ...
        let profile_state_change = ProfileStateChangeClient::new(
        ...
        let save_intents_to_confirm_after_delay =
            SaveIntentsToConfirmAfterDelayClient::new(
                drivers.unsafe_storage.clone(),
            );
        ...
        Self {
            ...
            save_intents_to_confirm_after_delay,
        }
    }
}
