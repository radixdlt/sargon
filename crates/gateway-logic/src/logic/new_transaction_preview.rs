...
pub trait TransactionPreviewRequestFromManifest: Sized {
    fn new_transaction_analysis(
...
impl TransactionPreviewRequestFromManifest for TransactionPreviewRequest {
    fn new_transaction_analysis(
        manifest: TransactionManifest,
        start_epoch_inclusive: Epoch,
        signer_public_keys: impl IntoIterator<Item = PublicKey>,
