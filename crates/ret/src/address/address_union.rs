...
macro_rules! address_union {
    (
        ...
        paste! {
            ...
            $(
                #[uniffi::export]
                pub fn [< new_ $union_name:snake _sample_ $variant_name:snake _mainnet >]() -> $union_name {
                    $union_name::[<sample_ $variant_name:snake _mainnet >]()
                }

                #[uniffi::export]
                pub fn [< new_ $union_name:snake _sample_ $variant_name:snake _mainnet_other >]() -> $union_name {
                    $union_name::[<sample_ $variant_name:snake _mainnet_other >]()
                }

                #[uniffi::export]
                pub fn [< new_ $union_name:snake _sample_ $variant_name:snake _stokenet >]() -> $union_name {
                    $union_name::[<sample_ $variant_name:snake _stokenet >]()
                }

                #[uniffi::export]
                pub fn [< new_ $union_name:snake _sample_ $variant_name:snake _stokenet_other >]() -> $union_name {
