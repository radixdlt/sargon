    ...
    (
        ...
        paste! {
            ...
            pub struct [< $address_type:camel Address >] {
                pub secret_magic: [< Ret $address_type:camel Address >], // Do NOT add comments above
            }
            ...
            uniffi::custom_type!([< Ret $address_type:camel Address >], String, {
                remote,
                from_custom: |addr| addr.to_string(),
                try_into_custom: |val| {
                    val.parse::<Self>()
                    .map_err(|_| {
            ...
            impl AddressViaRet for [< $address_type:camel Address >] {
                fn new(
                    ...
                    .map_err(|e| {
                        ...
                        CommonError::FailedToCreateAddressViaRetAddressFromNodeIdAndNetworkID {
