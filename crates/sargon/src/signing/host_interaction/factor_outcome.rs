...
#[derive(Clone, PartialEq, Eq, EnumAsInner, derive_more::Debug)]
...
mod test {
    ...
    pub fn test_failure() {
        ...
        let sut = SUT::failure(factor_source_id.clone());
    ...
    pub fn test_skipped() {
        ...
        let sut = SUT::skipped(factor_source_id.clone());
    ...
    pub fn test_irrelevant() {
        ...
        let sut = SUT::irrelevant(factor_source_id.clone());
